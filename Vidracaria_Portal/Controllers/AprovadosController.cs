...
namespace Vidracaria_Portal.Controllers
{
    public class AprovadosController : Controller
    {
        ...
        // GET: Aprovados
        public async Task<IActionResult> Index([Bind("CodigoAprovado,CodigoOrcamento,Nome,DataCadastro,Cidade,Bairro,NumeroCasa,Estado,Celular,Imagem")] AprovadosModel aprovadosModel, string filtro, string pesquisa, int? pagina)
        {
            if (ModelState.IsValid)
            {
                ...
                await _context.SaveChangesAsync(); // Dando Erro
            }
            ...
            var aprovados = from p in _context.VidrosTemperados select p;
            if (!String.IsNullOrEmpty(pesquisa))
            {
                aprovados = aprovados.Where(p => p.NomeVidro.Contains(pesquisa)).AsNoTracking();
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CodigoAprovado,CodigoOrcamento,Nome,DataCadastro,Cidade,Bairro,NumeroCasa,Estado,Celular,Imagem")] AprovadosModel aprovadosModel)
        {
