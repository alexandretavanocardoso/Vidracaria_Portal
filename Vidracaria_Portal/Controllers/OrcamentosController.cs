...
namespace Vidracaria_Portal.Controllers
{
    public class OrcamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodigoOrcamento,Nome,DataCadastro,Cidade,Bairro,NumeroCasa,Estado,Celular,Imagem")] OrcamentosModel orcamentosModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("CodigoOrcamento,Nome,DataCadastro,Cidade,Bairro,NumeroCasa,Estado,Celular,Imagem")] OrcamentosModel orcamentosModel)
        {
