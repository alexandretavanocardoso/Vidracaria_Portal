...
namespace Vidracaria_Portal.Controllers
{
    public class VidrosComunsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodigoVidro,NomeVidro,CorVidro,Marca,EstoqueMaximo,EstoqueMinimo,Expessura,PrecoVenda,PrecoFabrica,Imagem")] VidrosComunsModel vidrosComunsModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("CodigoVidro,NomeVidro,CorVidro,Marca,EstoqueMaximo,EstoqueMinimo,Expessura,PrecoVenda,PrecoFabrica,Imagem")] VidrosComunsModel vidrosComunsModel)
        {
